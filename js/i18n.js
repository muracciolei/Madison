...
const TRANSLATIONS = {
  ...
  es: {
    ...
    coffee_label: 'Invítame a un café',
  ...
  fr: {
    ...
    coffee_label: 'Offrez-moi un café',
  ...
  de: {
    ...
    coffee_label: 'Kauf mir einen Kaffee',
